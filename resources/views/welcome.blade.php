        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Layanan Laporan Warga Berbasis Online</h1>
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
                        <p>
                        <h3>LAGA </h3> Laga merupakan platform untuk membantu warga dengan mudah melaporkan kondisi
                        jalan yang rusak, fasilitas umum yang membutuhkan perhatian, dan permasalahan lainnya yang
                        mempengaruhi kehidupan sehari-hari warga Kota Surabaya.

                        Dengan adanya Laga dapat membantu Surabaya menjadi kota yang lebih baik melalui partisipasi
                        aktif warga. Maka, bergabunglah dengan Laga dan berkontribusilah dalam perbaikan infrastruktur
                        Kota Surabaya bersama-sama.
                        </p>
                        <ul>
                            <h3>Tujuan LAGA</h3>
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <p>
                        <h4>LAGA</h4>merupakan komitmen kami untuk melayani masyarakat. Dengan hadirnya sistem
                            ...
                            <div class="row">
                                <div class="col-md-6 d-md-flex align-items-md-stretch">
                                    <div class="count-box">
                                        ...
                                        <p><strong>Pengguna</strong><br>DAFTAR pengguna LAGA</p>
                                    </div>
                                </div>
